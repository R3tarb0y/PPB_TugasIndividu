package com.example.materi_5_2
...
class MainActivity : AppCompatActivity() {
    ...
    private fun tambahKartu() {
        ...
        titleTextView.text = "Apa itu algoritma?"

        // Mengatur deskripsi kartu
        descriptionTextView.text = "serangkaian langkah atau instruksi logis yang diberikan untuk menyelesaikan suatu masalah atau mencapai tujuan tertentu."
